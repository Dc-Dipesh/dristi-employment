...
export const metadata: Metadata = {
  title: "Destinations",
  description: "Explore job opportunities in Gulf, Europe, and East Asia. UAE, Qatar, Saudi Arabia, Romania, Japan, South Korea and more.",
};
  ...
  return (
    <>
      <PageHero
        badge="Where We Work"
        title="Destinations"
        highlight="We Place Workers"
        desc="From the Gulf to East Asia, we have trusted employer partnerships across 15+ countries in three major regions."
      />
      <Destinations />
      <CtaBanner />
    </>
  ...
  return (
    <section className="bg-navy py-14">
      <div className="max-w-2xl mx-auto px-4 text-center">
        <h2 className="text-2xl font-bold text-white mb-3">Ready to apply for your dream job abroad?</h2>
        <p className="text-white/60 mb-6">Get a free consultation with our placement specialists today.</p>
        <a
          href="/contact"
