            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center h-full py-12 text-center">
                ...
                <p className="text-gray-500 max-w-sm">
                  {f.successDesc(form.name, form.phone)}
                </p>
                <button
                  onClick={() => {
                    setSubmitted(false);
          ...
          <div className="lg:col-span-2 space-y-6 flex flex-col">
            <div className="bg-navy rounded-2xl p-6 text-white">
              ...
              <div className="space-y-4">
                {[
                  { icon: MapPin, label: o.addressLabel, content: o.address },
                  { icon: Phone, label: o.phoneLabel, content: o.phone, href: `tel:${o.phone}` },
                  { icon: Mail, label: o.emailLabel, content: o.email, href: `mailto:${o.email}` },
                  { icon: Clock, label: o.hoursLabel, content: o.hours },
                  ...
                  <div key={label} className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      {href ? (
                        <a href={href} className="text-white/70 text-sm hover:text-white transition-colors whitespace-pre-line">
                          {content}
                        </a>
                      ) : (
            ...
            <div className="flex-1 min-h-52 rounded-2xl overflow-hidden border border-gray-200 shadow-sm bg-gray-100">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3532.4624444246447!2d85.33685!3d27.7031!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb19b37a17ab3d%3A0x7f7b7d56e5b2b1c5!2sNew%20Baneshwor%2C%20Kathmandu%2044600!5e0!3m2!1sen!2snp!4v1234567890"
                width="100%"
                height="100%"
