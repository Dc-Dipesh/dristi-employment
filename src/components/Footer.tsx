...
const quickLinks = [
  ...
  { label_en: "Destinations",  label_ne: "गन्तव्यहरू",   href: "/destinations" },
  { label_en: "Our Process",   label_ne: "हाम्रो प्रक्रिया", href: "/process" },
  { label_en: "Our Team",      label_ne: "हाम्रो टिम",    href: "/team" },
  { label_en: "Contact",       label_ne: "सम्पर्क",        href: "/contact" },
];
...
export default function Footer() {
  ...
  const footerDestinations = destinationsData[language].regions.flatMap((r) =>
    r.countries.slice(0, 2).map((c) => c.name)
  );
